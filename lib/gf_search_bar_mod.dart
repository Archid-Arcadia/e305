...
typedef OnItemSubmitted<T> = void Function(String);
...
class GFSearchBar<T> extends StatefulWidget {
  ...
  /// defines what to do with onSubmit textfield
  final OnItemSubmitted<T> onItemSubmitted;
  ...
  MySingleChoiceSearchState<T> createState() =>
      MySingleChoiceSearchState<T>(initialText: initialText);
}
...
class MySingleChoiceSearchState<T> extends State<GFSearchBar<T>> {
  ...
  MySingleChoiceSearchState({this.initialText});
  ...
  Widget build(BuildContext context) {
    ...
    searchBox = Container(
      ...
      child: TextField(
        ...
        style: GoogleFonts.lexendDeca(fontSize: 16, color: Colors.grey[600]),
